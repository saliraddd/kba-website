...
urlpatterns = [
    ...
    path("services/ndt/ut/", views.ut_service, name="ut_service"),
    path("services/ndt/mt/", views.mt_service, name="mt_service"),
    path("services/ndt/pt/", views.pt_service, name="pt_service"),
    path("services/ndt/rt/", views.rt_service, name="rt_service"),
    path("services/ndt/vt/", views.vt_service, name="vt_service"),
    path("services/ndt/et/", views.et_service, name="et_service"),
